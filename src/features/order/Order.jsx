...
function Order() {
  ...
  // This fetcher data can be used to retrieve data that has been already used like a list of products in another route. With this it can retrieve it for you.
